...
private[x86] trait Instruction extends ModRM with Operands {
  ...
  def getAddressingForm2[X, Y](inst: Instruction2[X, Y])(implicit ev: MODRM_2Extended[X, Y]): AddressingFormSpecifier = {
    modRM2Extended(inst.operand1, inst.operand2, inst.opcodeExtension.get)
  }

  def getAddressingForm1[X](inst: Instruction1[X])(implicit ev: MODRM_1Extended[X]): AddressingFormSpecifier = {
