...
trait ADDLow {
  implicit object ADD_0 extends ADD._2[rm8, r8] {
    val opcode: OneOpcode = 0x0 /r
  }

  implicit object ADD_1 extends ADD._2[rm16, r16] {
    val opcode: OneOpcode = 0x1 /r
  }
