...
trait Catalog {
  ...
  def push[O1 <: Operand](p1: O1)(implicit ev: PUSH_1[_,O1]) = ev(p1)

  def pop[O1 <: Operand](p1: O1)(implicit ev: POP_1[_,O1]) = ev(p1)
  ...
  def jz[O1 <: Operand](p1: O1)(implicit ev: JZ_1[_,O1]) = ev(p1)
