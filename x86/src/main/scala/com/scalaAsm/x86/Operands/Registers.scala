...
abstract class AccumulatorRegister[Size: x86Size](name: String) extends GeneralPurpose[Size](name)  { val ID: Byte = 0 } 
...
class AH extends AccumulatorRegister[_8]("ah") { override val ID: Byte = 4 }

// "B" family - Pointer to data in the DS segment
abstract class DataPointerRegister[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 3 }
...
class BH extends DataPointerRegister[_8]("bh") { override val ID: Byte = 7 }

// "C" family - Counter for string and loop operations
abstract class CounterRegister[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 1 }
...
class CH extends CounterRegister[_8]("ch") { override val ID: Byte = 5 }

// "D" family - I/O pointer
abstract class IORegister[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 2 }
...
class DH extends IORegister[_8]("dh") { override val ID: Byte = 6 }

// Stack pointer (in the SS segment)
abstract class StackPointer[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 4 }
...
abstract class BasePointer[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 5 }
...
abstract class SourceIndex[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 6 }
...
abstract class DestinationIndex[Size: x86Size](name: String) extends GeneralPurpose[Size](name) { val ID: Byte = 7 }
...
class ES extends SegmentRegister("es") { val ID: Byte = 8 }
class CS extends SegmentRegister("cs") { val ID: Byte = 8 }
class SS extends SegmentRegister("ss") { val ID: Byte = 8 }
class DS extends SegmentRegister("ds") { val ID: Byte = 8 }
class FS extends SegmentRegister("fs") { val ID: Byte = 8 }
class GS extends SegmentRegister("gs") { val ID: Byte = 8 }
...
class R8 extends Extra64Reg("r8") { val ID: Byte = 0 }
class R9 extends Extra64Reg("r9") { val ID: Byte = 1 }
class R10 extends Extra64Reg("r10") { val ID: Byte = 2 }
class R11 extends Extra64Reg("r11") { val ID: Byte = 3 }
class R12 extends Extra64Reg("r12") { val ID: Byte = 4 }
class R13 extends Extra64Reg("r13") { val ID: Byte = 5 }
class R14 extends Extra64Reg("r14") { val ID: Byte = 6 }
class R15 extends Extra64Reg("r15") { val ID: Byte = 7 }

abstract class SSERegister(name: String) extends GeneralPurpose[_128](name)
class XMM0 extends SSERegister("xmm0") { val ID: Byte = 0 }
class XMM1 extends SSERegister("xmm1") { val ID: Byte = 1 }
class XMM2 extends SSERegister("xmm2") { val ID: Byte = 2 }
class XMM3 extends SSERegister("xmm3") { val ID: Byte = 3 }
class XMM4 extends SSERegister("xmm4") { val ID: Byte = 4 }
class XMM5 extends SSERegister("xmm5") { val ID: Byte = 5 }
class XMM6 extends SSERegister("xmm6") { val ID: Byte = 6 }
class XMM7 extends SSERegister("xmm7") { val ID: Byte = 7 }