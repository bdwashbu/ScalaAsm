...
private[x86] trait ModRM {
  ...
  implicit object mod3 extends MODRM[*[r32 + imm8], r32] { def get(x: *[r32 + imm8], y: r32) = mod4.get(y, x) }
  ...
  implicit object mod4 extends MODRM[r32, *[r32 + imm8]] {
  ...
  implicit object mod5 extends MODRM[r32, *[r32 + imm32]] { def get(x: r32, y: *[r32 + imm32]) = { Array(0x8D.toByte, 0x8F.toByte) ++ Endian.swap(y.x.offset.value) } }
}