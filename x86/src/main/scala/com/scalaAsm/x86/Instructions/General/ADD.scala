...
trait ADDImpl extends ADDLow {
  ...
  implicit object ADD_8 extends ADD._1[imm8] {
    def opcode = 0x4
    override def hasImplicitOperand = true
  }

  implicit object ADD_9 extends ADD._1[imm16] {
    def opcode = 0x5
    override def hasImplicitOperand = true
  }

  implicit object ADD_10 extends ADD._1[imm32] {
    def opcode = 0x5
    override def hasImplicitOperand = true
  }

  implicit object ADD_11 extends ADD._2[rm8, imm8] {
    def opcode = 0x80 /+ 0
  }

  implicit object ADD_12 extends ADD._2[rm16, imm16] {
    def opcode = 0x81 /+ 0
  }

  implicit object ADD_13 extends ADD._2[rm32, imm32] {
    def opcode = 0x81 /+ 0
  }

  implicit object ADD_14 extends ADD._2[rm64, imm32] {
    def opcode = 0x81 /+ 0
    override def prefix = REX.W(true)
  }

  implicit object ADD_15 extends ADD._2[rm16, imm8] {
    def opcode = 0x83 /+ 0
  }

  implicit object ADD_16 extends ADD._2[rm32, imm8] {
    def opcode = 0x83 /+ 0
  }

  implicit object ADD_17 extends ADD._2[rm64, imm8] {
    def opcode = 0x83 /+ 0
    override def prefix = REX.W(true)
  }
}
