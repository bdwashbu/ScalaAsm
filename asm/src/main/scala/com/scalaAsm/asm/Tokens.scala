...
object Tokens {
  ...
  case class LabelRef(labelRef: String, inst:OperandInstruction[OneOpcode]#OneOp[Constant8, I], format: OneOperandFormat[Constant8, I]) extends CodeToken with InstructionResult {
    def line = ""
    def getSize = 0
    def getBytes = Array()
  } 
