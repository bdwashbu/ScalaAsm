...
object MOV extends Instruction {
  ...
  implicit object mov9 extends MOV_R[r16, r16] { def get(x: r16, y: r16) = 0x8B.toByte +: modRM2(x, y) }

  implicit object mov5 extends MOV_R[r32, *[r32]] { def get(x: r32, y: *[r32]) = 0x8B.toByte +: modRM2(x, y) }
