...
trait PUSH extends ModRMFormat with Operands
...
object PUSH extends Instruction {
  ...
  implicit object push6 extends PUSH_M[*[r32 + imm8]] { def get(x: *[r32 + imm8]) = 0xFF.toByte +: modRMExtended(x, extensionCode = 6.toByte) }
