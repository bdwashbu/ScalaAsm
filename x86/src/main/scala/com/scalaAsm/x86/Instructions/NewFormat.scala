...
trait NewLowPriorityFormats {
 ...
 // implicit object New_I2Format extends NewTwoOperandFormat[ModRM.reg, imm] {
...
//  }
  ...
  implicit object New_RMFormat2 extends NewTwoOperandFormat[ModRM.reg, AbsoluteAddress[_32]] {
