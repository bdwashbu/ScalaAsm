...
trait CMPImpl extends CMPLow {
  ...
  implicit object CMP_8 extends CMP._1[imm8] {
    def opcode = 0x3C
    override def hasImplicitOperand = true
  }

  implicit object CMP_9 extends CMP._1[imm16] {
    def opcode = 0x3D
    override def hasImplicitOperand = true
  }

  implicit object CMP_10 extends CMP._1[imm32] {
    def opcode = 0x3D
    override def hasImplicitOperand = true
  }

  implicit object CMP_11 extends CMP._2[rm8, imm8] {
    def opcode = 0x80 /+ 7
  }

  implicit object CMP_12 extends CMP._2[rm16, imm16] {
    def opcode = 0x81 /+ 7
  }

  implicit object CMP_13 extends CMP._2[rm32, imm32] {
    def opcode = 0x81 /+ 7
  }

  implicit object CMP_14 extends CMP._2[rm64, imm32] {
    def opcode = 0x81 /+ 7
    override def prefix = REX.W(true)
  }

  implicit object CMP_15 extends CMP._2[rm16, imm8] {
    def opcode = 0x83 /+ 7
  }

  implicit object CMP_16 extends CMP._2[rm32, imm8] {
    def opcode = 0x83 /+ 7
  }

  implicit object CMP_17 extends CMP._2[rm64, imm8] {
    def opcode = 0x83 /+ 7
    override def prefix = REX.W(true)
  }
}
