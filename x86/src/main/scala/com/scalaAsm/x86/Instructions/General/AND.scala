...
trait ANDImpl extends ANDLow {
  ...
  implicit object AND_8 extends AND._1[imm8] {
    def opcode = 0x24
    override def hasImplicitOperand = true
  }

  implicit object AND_9 extends AND._1[imm16] {
    def opcode = 0x25
    override def hasImplicitOperand = true
  }

  implicit object AND_10 extends AND._1[imm32] {
    def opcode = 0x25
    override def hasImplicitOperand = true
  }

  implicit object AND_11 extends AND._2[rm8, imm8] {
    def opcode = 0x80 /+ 4
  }

  implicit object AND_12 extends AND._2[rm16, imm16] {
    def opcode = 0x81 /+ 4
  }

  implicit object AND_13 extends AND._2[rm32, imm32] {
    def opcode = 0x81 /+ 4
  }

  implicit object AND_14 extends AND._2[rm64, imm32] {
    def opcode = 0x81 /+ 4
    override def prefix = REX.W(true)
  }
}
